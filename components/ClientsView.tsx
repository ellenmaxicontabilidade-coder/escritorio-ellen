                                    ...
                                    <div className="modal-overlay" onClick={() => setShowModal(false)}>
                                                        <div className="modal-box" onClick={e => e.stopPropagation()} style={{ width: 520, maxWidth: '95vw' }}>
                                                                        ...
                                                                        <div style={{ border: '1px solid var(--border-light)', borderRadius: 10, padding: 14, marginTop: 4 }}>
                                                                            ...
                                                                            {drawerStep === 2 && (
                                                                                                                    <div>
                                                                                                                                                                <div style={{ fontWeight: 500, marginBottom: 10, fontSize: 13 }}>Selecionar cliente</div>
                                                                                                                                                                <input
                                                                                                                                                                                                                    className="form-input"
                                                                                                                                                                                                                    placeholder="Buscar cliente..."
                                                                                                                                                                                                                    value={drawerSearch}
                                                                            ...
                                                                            {drawerStep === 3 && (
                                                                                                                    <div>
                                                                                                                                                                <div style={{ fontWeight: 500, marginBottom: 10, fontSize: 13 }}>Relacao</div>
                                                                                                                        ...
                                                                                                                        {drawerRels.includes('Outros') && (
                                                                                                                                                                ...
                                                                                                                                                                <div style={{ display: 'flex', gap: 8, marginTop: 12 }}>
                                                                                                                                                                                                                ...
                                                                                                                                                                                                                <button className="btn btn-ghost" onClick={() => setDrawerOpen(false)}>Cancelar</button>
                                                                                                                                                                                                            </div>
                                                                                                                        </div>
                                                                                                            )}
                                                                            </div>

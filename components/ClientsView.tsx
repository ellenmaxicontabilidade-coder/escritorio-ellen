                                    ...
                                    {/* Header da lista */}
                                                    <div style={{ display: 'flex', gap: 8, padding: '1rem', borderBottom: '0.5px solid var(--border-light)', background: 'var(--bg-primary)', flexShrink: 0 }}>
                                                                            <input
                                                                                                    ...
                                                                                                    />
                                                                            <button className="btn btn-primary" onClick={openNew}>+ Novo cliente</button>button>
                                                    </div>div>
                                    {/* Lista scrollavel */}
                                            ...
                                            const groupLabel = isGroup
                                                ? group.map(c => c.name.split(' ')[0].toUpperCase()).join(' + ')
                                                                            : null
                                            return (
                                                ...
                                                onClick={() => setSelectedId(c.id)}
                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                                                                                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                                                                                    <div style={{ flex: 1, minWidth: 0 }}>
                                                                                                                                                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                                                                                                                                                            <div style={{ fontSize: 12, color: 'var(--text-secondary)', marginTop: 2 }}>{c.meta}</div>div>
                                                                                                                                                                                                                                                                                                                                                                                                                            {vs.length > 0 && (
                                                                                                                                                                                                                                                                                                                                                                                <div style={{ fontSize: 11, color: 'var(--text-secondary)', marginTop: 3, display: 'flex', gap: 4, flexWrap: 'wrap' }}>
                                                                                                                                                                                                                                                                                                                                                                                                                                                {vs.map(v => (
                                                                                                                                                                                                                                                                                                                                                                                                                                                        <span key={v.id}>
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                <span style={{ marginRight: 2 }}>&#8596;</span>span>
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                {v.linked_client?.name || v.linked_id}
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                <span className="badge" style={{ marginLeft: 4, fontSize: 9 }}>{v.rels[0]}</span>span>
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            </span>span>
                                                                                                                                                                                                                                                                                                                                                                                                                                                    ))}
                                                                                                                                                                                                                                                                                                                                                                                                                                            </div>div>
                                                                                                                                                                                                                                                                                                                                                                                                                            )}
                                                        ...
                                                        {groups.length === 0 && (
                                            <div className="empty">Nenhum cliente encontrado.</div>div>
                                                                        )}
                                                    </div>div>
                                </div>div>
                            ...
                            <div style={{ overflowY: 'auto', background: 'var(--bg-secondary)' }}>
                                {selectedClient ? (
                                        ...
                                        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height: '100%', color: 'var(--text-secondary)', gap: 8 }}>
                                                                <span style={{ fontSize: 32 }}>&#128101;</span>span>
                                                                <div style={{ fontWeight: 500 }}>Selecione um cliente</div>div>
                                    ...
                                    <div className="modal-overlay" onClick={() => setShowModal(false)}>
                                                        <div className="modal" onClick={e => e.stopPropagation()} style={{ width: 520, maxWidth: '95vw' }}>
                                                                                <div className="modal-header">
                                                                                                            ...
                                                                                                            <button className="btn btn-icon btn-ghost" onClick={() => setShowModal(false)}>&#10005;</button>button>
                                                                                    </div>div>
                                                                                ...
                                                                                const active = form.badges.includes(b)
                                                                                                                            return (
                                                                                                                                                                            <button
                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                className={`badge badge-${b === 'PF' ? 'pf' : b === 'PJ' ? 'pj' : 'rep'}`}
                                                                                                                                                                                                                                style={{
                                                                                                                                                                                                                                                                                        cursor: 'pointer',
                                                                        ...
                                                                        <div className="form-field">
                                                                                                            ...
                                                                                                            <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
                                                                                                                {savedVinculos.map(v => (
                                                                                                                        <div key={v.id} style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '6px 10px', background: 'var(--bg-secondary)', borderRadius: 8, border: '1px solid var(--border-light)' }}>
                                                                                                                                                                        ...
                                                                                                                                                                        <div style={{ flex: 1, fontSize: 13 }}>
                                                                                                                                                                                                                            <span style={{ fontWeight: 500 }}>{v.linked_client?.name || v.linked_id}</span>span>
                                                                                                                                                                                                                            <span style={{ marginLeft: 6, color: 'var(--text-secondary)', fontSize: 11 }}>{v.rels.join(', ')} &bull; {v.tipo === 'rep' ? 'Representante' : 'Representado'}</span>span>
                                                                                                                                                                                                                        </div>div>
                                                                                                                                                                        <button
                                                                                                                ...
                                                                                                                {pendingVinculos.map((pv, i) => (
                                                                                                                        <div key={i} style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '6px 10px', background: 'var(--bg-secondary)', borderRadius: 8, border: '1px solid var(--border-light)' }}>
                                                                                                                                                                        <div style={{ flex: 1, fontSize: 13 }}>
                                                                                                                                                                                                                            <span style={{ fontWeight: 500 }}>{pv.linked_name}</span>span>
                                                                                                                                                                                                                            <span style={{ marginLeft: 6, color: 'var(--text-secondary)', fontSize: 11 }}>{pv.rels.join(', ')} &bull; {pv.tipo === 'rep' ? 'Representante' : 'Representado'}</span>span>
                                                                                                                                                                                                                        </div>div>
                                                                                                                                                                        <button
                                                                                                                                                                                                                                className="btn btn-icon btn-ghost"
                                                                                                                                                                                                                                style={{ width: 24, height: 24, fontSize: 12, color: 'var(--danger)' }}
                                                                                    ...
                                                                                    {/* Adicionar vinculo */}
                                                                                    {!drawerOpen ? (
                                                                        <button className="btn btn-ghost" style={{ width: '100%', marginTop: 4 }} onClick={() => { setDrawerOpen(true); setDrawerStep(1); setDrawerTipo(null); setDrawerClientId(null); setDrawerRels([]); setDrawerOutro(''); setDrawerSearch('') }}>
                                                                                                            + Adicionar vinculo
                                                                            </button>button>
                                                                    ) : (
                                                                        <div style={{ border: '1px solid var(--border-light)', borderRadius: 10, padding: 14, marginTop: 4 }}>
                                                                            {drawerStep === 1 && (
                                                                                                                    <div>
                                                                                                                                                                <div style={{ fontWeight: 500, marginBottom: 10, fontSize: 13 }}>Tipo de vinculo</div>div>
                                                                            ...
                                                                            {drawerStep === 2 && (
                                                                                                                    <div>
                                                                                                                                                                <div style={{ fontWeight: 500, marginBottom: 10, fontSize: 13 }}>Selecionar cliente</div>div>
                                                                                                                                                                <input
                                                                                                                                                                                                                    className="form-input"
                                                                                                                                                                                                                    placeholder="Buscar cliente..."
                                                                                                                                                                                                                    value={drawerSearch}
                                                                                                                                                                                                                ...
                                                                                                                                                                                                                {clients
                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                        .map(c => (
                                                                                                                                                                                                                                                                                                                                    <div
                                                                                                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                                                                                                >
                                                                                                                                                                                                                                                                                                                                                                                                <div className="avatar" style={{ width: 28, height: 28, fontSize: 11, background: c.av_bg, color: c.av_cl }}>{ini(c.name)}</div>div>
                                                                                                                                                                                                                                                                                                                                                                                                <span style={{ fontSize: 13 }}>{c.name}</span>span>
                                                                                                                                                                                                                                                                                                                                                                                            </div>div>
                                                                                                                                                                                                                                                                                                                                ))
                                                                                                                                                                                                                                                                    }
                                                                                                                                                                                                            </div>div>
                                                                            ...
                                                                            {drawerStep === 3 && (
                                                                                                                    <div>
                                                                                                                                                                <div style={{ fontWeight: 500, marginBottom: 10, fontSize: 13 }}>Relacao</div>div>
                                                                                                                        ...
                                                                                                                        {drawerRels.includes('Outros') && (
                                                                                                                                                                        <input className="form-input" style={{ marginTop: 8 }} placeholder="Especificar..." value={drawerOutro} onChange={e => setDrawerOutro(e.target.value)} />
                                                                                                                                                                    )}
                                                                                                                                                                <div style={{ display: 'flex', gap: 8, marginTop: 12 }}>
                                                                                                                                                                                                                <button
                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                        onClick={() => {
                                                                                                                                                                                                                                                                                                                                    const linked = clients.find(c => c.id === drawerClientId)
                                                                                                                                                                                                                                                                                                                                                                                                if (!linked || !drawerTipo) return
                                                                                                                                                                                                                                                                                                                                                                                                                                                            setPendingVinculos(prev => [...prev, {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            linked_id: linked.id,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            linked_name: linked.name,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            rels: drawerRels.includes('Outros') && drawerOutro ? [...drawerRels.filter(r => r !== 'Outros'), drawerOutro] : drawerRels,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            tipo: drawerTipo,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        }])
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        setDrawerOpen(false)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                }}
                                                                                                                                                                                                                ...
                                                                                                                                                                                                                <button className="btn btn-ghost" onClick={() => setDrawerOpen(false)}>Cancelar</button>button>
                                                                                                                                                                                                            </div>div>
                                                                                                                        </div>div>
                                                                                                            )}
                                                                            </div>div>
                                                                                ...
                                                                                <div className="modal-footer">
                                                                                                            <button className="btn btn-ghost" onClick={() => setShowModal(false)}>Cancelar</button>button>
                    ...
                    {confirmDelete && (
                                    <div className="modal-overlay" onClick={() => setConfirmDelete(null)}>
                                                        <div className="modal" onClick={e => e.stopPropagation()} style={{ width: 420 }}>
                                                                                <div className="modal-header">
                                                                                                            <div className="modal-title">Excluir cliente</div>div>
                                                                                                            <button className="btn btn-icon btn-ghost" onClick={() => setConfirmDelete(null)}>&#10005;</button>button>
                                                                                    </div>div>
                                                                                <div className="modal-body">
                                                                                                            <div style={{ background: '#FEF2F2', border: '1px solid #FCA5A5', borderRadius: 10, padding: '12px 16px', marginBottom: 16 }}>
                                                                                                                                            <div style={{ color: '#DC2626', fontWeight: 600, fontSize: 14, marginBottom: 4 }}>&#9888; Esta acao nao pode ser desfeita.</div>div>
                                                                                                                                            <div style={{ color: '#991B1B', fontSize: 13 }}>Todos os servicos e tarefas do cliente serao permanentemente excluidos.</div>div>
                                                                                                                </div>div>
                                                                                ...
                                                                                <div className="modal-footer">
                                                                                                            <button className="btn btn-ghost" onClick={() => setConfirmDelete(null)}>Cancelar</button>button>

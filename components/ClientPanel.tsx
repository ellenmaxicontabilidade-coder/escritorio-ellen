                ...
                <div style={{ padding: '1.25rem 1.5rem', borderBottom: '0.5px solid var(--border-light)', background: 'var(--bg-primary)', display: 'flex', alignItems: 'flex-start', gap: 14 }}>
                  ...
                  {/* Menu tres pontinhos */}
                        <div ref={dotsRef} style={{ position: 'relative', flexShrink: 0 }}>
                          ...
                          {showDotsMenu && (
                      <div style={{ position: 'absolute', top: 'calc(100% + 5px)', right: 0, background: 'var(--bg-primary)', border: '0.5px solid var(--border-medium)', borderRadius: 'var(--radius-lg)', overflow: 'hidden', zIndex: 200, minWidth: 180, boxShadow: '0 4px 16px rgba(0,0,0,0.10)' }}>
                                    <div
              ...
              <div style={{ flex: 1, overflowY: 'auto' }}>
                    ...
                    <div>
                      {vinculos.map(v => (
                                    <div key={v.id} style={{ padding: '0.875rem 1.5rem', borderBottom: '0.5px solid var(--border-light)', display: 'flex', alignItems: 'center', gap: 12, background: 'var(--bg-primary)' }}>
                                                    ...
                                                    <div style={{ flex: 1, minWidth: 0 }}>
                                                                      <div style={{ fontSize: 14, fontWeight: 500 }}>{v.linked_client?.name || v.linked_id}</div>div>
                                                                      <div style={{ fontSize: 12, color: 'var(--text-secondary)' }}>{v.rels.join(', ')} &bull; {pending} pendente{pending !== 1 ? 's' : ''}</div>div>
                                                    </div>div>
                                                    <span className="badge" style={{ background: '#EEF6FF', color: '#2563EB', fontSize: 11 }}>&#8226; Sync</span>span>
                                                    <span style={{ color: 'var(--text-secondary)', fontSize: 14 }}>&#8250;</span>span>
                                    </div>div>
                                  ))}
                    </div>div>
                      )}
                ...
                {client.obs && (
                    <div style={{ padding: '1rem 1.5rem', borderBottom: '0.5px solid var(--border-light)' }}>
                                <div style={{ fontSize: 10, fontWeight: 700, letterSpacing: 1, color: 'var(--text-secondary)', marginBottom: 8 }}>OBSERVACOES</div>div>
                ...
                {/* Servicos e Tarefas */}
                      <div style={{ padding: '1rem 1.5rem' }}>
                                <div style={{ fontSize: 10, fontWeight: 700, letterSpacing: 1, color: 'var(--text-secondary)', marginBottom: 12 }}>SERVICOS E TAREFAS</div>div>
                        {loading ? (
                      <div className="empty">Carregando...</div>div>
                    ) : services.length === 0 ? (
                      <div className="empty">Nenhum servico cadastrado.</div>div>
                    ) : (
                                                                                                                  ...
                                                                                                                  <div key={svc.id} className="card" style={{ padding: 0, overflow: 'hidden', border: '1px solid var(--border-light)' }}>
                                                                                                                                      <div
                                                                                                                                                            ...
                                                                                                                                                            <div style={{ width: 30, height: 30, borderRadius: 8, background: tipoBg[svc.tipo] || '#f5f5f5', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                                                                                                                                                                                    <span style={{ color: tipoCl[svc.tipo] || '#666', fontSize: 14 }}>&#9776;</span>span>
                                                                                                                                                              </div>div>
                                                                                                                                                            <div style={{ flex: 1, minWidth: 0 }}>
                                                                                                                                                                                    <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                                                                                                                                                                                                              <span style={{ fontSize: 13, fontWeight: 500 }}>{svc.nome}</span>span>
                                                                                                                                                                                                              {svc.sync_group && <span className="badge" style={{ background: '#EEF6FF', color: '#2563EB', fontSize: 10 }}>Sync</span>span>}
                                                                                                                                                                                                            </div>div>
                                                                                                                                                              {svc.orig && <div style={{ fontSize: 11, color: 'var(--text-secondary)' }}>{svc.orig}</div>div>}
                                                                                                                                                              </div>div>
                                                                                                                                        {pend > 0 && (
                                                                                                                                                            ...
                                                                                                                                                            <span style={{ color: 'var(--text-secondary)', fontSize: 12 }}>{isOpen ? '&#8743;' : '&#8744;'}</span>span>
                                                                                                                                        </div>div>
                                                                                                                    {isOpen && (
                                                                                                                                                                                                  ...
                                                                                                                                                                                                  <div style={{ display: 'flex', alignItems: 'flex-start', gap: 10 }}>
                                                                                                                                                                                                            ...
                                                                                                                                                                                                            <span style={{ fontSize: 10, background: sub.resp === 'Ellen Maximiano' ? '#EEF6FF' : '#FFF7ED', color: sub.resp === 'Ellen Maximiano' ? '#2563EB' : '#C2410C', borderRadius: 4, padding: '2px 6px' }}>
                                                                                                                                                                                                                                                  {sub.resp.split(' ')[0]}
                                                                                                                                                                                                                                                                                                  ...
                                                                                                                                                                                                                                                                                                  {sub.sync_group && <span className="badge" style={{ fontSize: 10, background: '#EEF6FF', color: '#2563EB' }}>Sync</span>span>}
                                                                                                                                                                                                                                                                                                  {sub.date && <span style={{ fontSize: 10, color: 'var(--text-secondary)' }}>{fmtDate(sub.date, sub.time) || ''}</span>span>}
                                                                                                                                                                                                                                                                                                </div>div>
                                                                                                                                                                                                                                                              </div>div>
                                                                                                                                                                                                                                <button
                                                                                                                                                                                                      ...
                                                                                                                                                                                                      <div style={{ marginLeft: 33, marginTop: 8 }}>
                                                                                                                                                                                                                                      {(comments[sub.id] || []).map((c, i) => (
                                                                                                                                                                                                                                          <div key={i} style={{ fontSize: 12, color: 'var(--text-secondary)', marginBottom: 4 }}>
                                                                                                                                                                                                                                                                              <span style={{ fontWeight: 500, color: 'var(--text-primary)' }}>{c.init}</span>span> {c.text}
                                                                                                                                                                                                                                                                              <span style={{ marginLeft: 6, fontSize: 10 }}>{c.dt}</span>span>
                                                                                                                                                                                                                                                                            </div>div>
                                                                                                                                                                                                                                        ))}
                                                                                                                                                                                                                                      <div style={{ display: 'flex', gap: 6, marginTop: 4 }}>
                                                                                                                                                                                                                                                                        <input
                                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                                            />
                                                                                                                                                                                                                                                                        <button className="btn btn-primary" style={{ fontSize: 11, padding: '4px 10px' }} onClick={() => sendComment(sub.id)}>OK</button>button>
                                                                                                                                                                                                                                                                      </div>div>
                                                                                                                                                                                                                                    </div>div>
                                                                                                                                                                                                  )}
                                                                                                                                                                        </div>div>
                                                                                                                                            ...
                                                                                                                                            {addFormSvc === svc.id ? (
                                                                                                                                                                      <div style={{ padding: '0.75rem 1rem', background: 'var(--bg-secondary)' }}>
                                                                                                                                                                                                  ...
                                                                                                                                                                                                  <div style={{ display: 'flex', gap: 6 }}>
                                                                                                                                                                                                                                <button className="btn btn-primary" style={{ flex: 1 }} onClick={() => saveSubtask(svc.id)}>Salvar</button>button>
                                                                                                                                                                                                                                <button className="btn btn-ghost" onClick={() => setAddFormSvc(null)}>Cancelar</button>button>
                                                                                                                                                                                                                              </div>div>
                                                                                                                                                                        </div>div>
                                                                                                                                                                    ) : (
                                                                                                                                                                      <div style={{ padding: '0.625rem 1rem', display: 'flex', gap: 6 }}>
                                                                                                                                                                                                  <button
                                                                                                                                                                                                                                  ...
                                                                                                                                                                                                                                  style={{ fontSize: 12 }}
                                                                                                                                                                                                                                  onClick={() => { setAddFormSvc(svc.id); setAddForm({ title: '', date: '', time: '', resp: 'Ellen Maximiano', obs: '' }) }}
                                                                                                                                                                                                                                >
                                                                                                                                                                                                                                + Adicionar subtarefa
                                                                                                                                                                                                                              </button>button>
                                                                                                                                                                        </div>div>

                                                                    ...
                                                                    return (
                                                                                          <div key={v.id} style={{ padding: '0.875rem 1.5rem', borderBottom: '0.5px solid var(--border-light)', display: 'flex', alignItems: 'center', gap: 12, background: 'var(--bg-primary)' }}>
                                                                                                            ...
                                                                                                            <div style={{ flex: 1, minWidth: 0 }}>
                                                                                                                                ...
                                                                                                                                <div style={{ fontSize: 12, color: 'var(--text-secondary)' }}>{v.rels.join(', ')} &bull; {pendLabel(pending)} &bull; {papel}</div>div>
                                                                                                                  </div>div>
                        ...
                        {/* Servicos e Tarefas */}
                          <div style={{ padding: '1rem 1.5rem' }}>
                                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 12 }}>
                                                <div style={{ fontSize: 10, fontWeight: 700, letterSpacing: 1, color: 'var(--text-secondary)' }}>SERVICOS E TAREFAS</div>div>
                                          {services.length > 0 && (
                                <button
                                                                                                                                                                                ...
                                                                                                                                                                                {addFormSvc === svc.id ? (
                                                                                                                                                                                                          <div style={{ padding: '0.75rem 1rem', background: 'var(--bg-secondary)' }}>
                                                                                                                                                                                                                                      ...
                                                                                                                                                                                                                                      <select className="form-input" value={addForm.papel} onChange={e => setAddForm(f => ({ ...f, papel: e.target.value }))} style={{ marginBottom: 6 }}>
                                                                                                                                                                                                                                                                    <option value="Representado">Representado</option>option>
                                                                                                                                                                                                                                                                    <option value="Representante">Representante</option>option>
                                                                                                                                                                                                                                                                  </select>select>

              ...
              <div style={{ flex: 1, overflowY: 'auto' }}>
                      ...
                      {vinculos.map(v => (
                                    <div key={v.id} style={{ padding: '0.875rem 1.5rem', borderBottom: '0.5px solid var(--border-light)', display: 'flex', alignItems: 'center', gap: 12, background: 'var(--bg-primary)' }}>
                                                    ...
                                                    <div style={{ flex: 1, minWidth: 0 }}>
                                                                      ...
                                                                      <div style={{ fontSize: 12, color: 'var(--text-secondary)' }}>{v.rels.join(', ')} &bull; {pending} pendente{pending !== 1 ? 's' : ''}</div>
                                                    </div>
                ...
                {/* Servicos e Tarefas */}
                      <div style={{ padding: '1rem 1.5rem' }}>
                                <div style={{ fontSize: 10, fontWeight: 700, letterSpacing: 1, color: 'var(--text-secondary)', marginBottom: 12 }}>SERVICOS E TAREFAS</div>
                        {loading ? (
                      <div className="empty">Carregando...</div>
                    ) : services.length === 0 ? (
                      <div className="empty">Nenhum servico cadastrado.</div>
                    ) : (
                                                                                                                                                                                                      ...
                                                                                                                                                                                                      <div style={{ marginLeft: 33, marginTop: 8 }}>
                                                                                                                                                                                                                                      ...
                                                                                                                                                                                                                                      <div style={{ display: 'flex', gap: 6, marginTop: 4 }}>
                                                                                                                                                                                                                                                                        <input
                                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                                            />
                                                                                                                                                                                                                                                                        <button className="btn btn-primary" style={{ fontSize: 11, padding: '4px 10px' }} onClick={() => sendComment(sub.id)}>OK</button>
                                                                                                                                                                                                                                                                      </div>
                                                                                                                                                                                                                                    </div>
                                                                                                                                                                                                  )}
                                                                                                                                                                        </div>
